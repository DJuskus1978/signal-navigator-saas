...
export default function MarketingPlanPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0A0F2E" }}>
      ...
      <header style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(10,15,46,0.92)", backdropFilter: "blur(12px)", borderBottom: "1px solid #1E3A7B" }} className="print:hidden">
